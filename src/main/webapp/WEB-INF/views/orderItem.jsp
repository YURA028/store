                ...
                <form class="needs-validation" novalidate="">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="same-address">
                            <label style="vertical-align: inherit;">
                                <label style="vertical-align: inherit;">Адрес доставки совпадает с моим платежным адресом</label>
                            </label>
                        </label>
                    </div>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="save-info">
                            <label style="vertical-align: inherit;">
                                <label style="vertical-align: inherit;">Сохраните эту информацию для следующего раза</label>
                            </label>
                        </label>
                    </div>
                    ...
                    <div class="row gy-3">
                        <div class="col-md-6">
                            ...
                            <small class="text-muted">
                                <label style="vertical-align: inherit;">
                                    <label style="vertical-align: inherit;">Полное имя, отображаемое на карточке</label>
                                </label>
                            </small>
                            <div class="invalid-feedback">
