...
<%--&lt;%&ndash;                                    <label for="availability" class="col-md-3 control-label">Availability</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <div class="col-md-9">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <form:input path="availability" cssClass="form-control" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                                <div class="form-group">--%>
...
<%--                                </div>--%>
<%--&lt;%&ndash;                                <div class="form-group">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <label for="saveProduct.maker.name" class="col-md-3 control-label">Maker</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <div class="col-md-9">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <form:input path="saveProduct.maker.name" cssClass="form-control" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <div class="form-group">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <label for="saveProduct.productType.name" class="col-md-3 control-label">ProductType</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <div class="col-md-9">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <form:input path="saveProduct.productType.name" cssClass="form-control" />&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                </div>&ndash;%&gt;--%>
