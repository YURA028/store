        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="card-header bg-white nav">
                ...
                <div class="col p-4 flex-column position-static">
                    name: <b>${users.firstName}</b><br>
                    Логин: <b>${users.username}</b><br>
                    Email: <b>${users.email}</b><br>
                    Role: <b>${userPrincipal.role.name()}</b><br>
                    Status: <b>${userPrincipal.state.name()}</b><br><br>
                    <h5>Address:</h5>
                    ...
                    <spring:message code="address.phone"/>:<b>${userPrincipal.address.phone}</b><br>
                    <spring:message code="address.city"/>:<b>${userPrincipal.address.city}</b><br>
                    <spring:message code="address.street"/>: <b>${userPrincipal.address.street}</b><br>
                    <spring:message code="address.building"/>: <b>${userPrincipal.address.building}</b>
                    <br>
                    <br>
                </div>
                <br><br>
                ...
                <div class="col p-4 d-flex flex-column position-static">
                    <div class="text-end ">
                        <form action="/my/products" method="get">
                            <button type="submit" class="btn btn-outline-success col-sm-8 col-sm offset-1">
                                ...
                                <spring:message code="title.my.product"/>
                            </button>
                        </form>
                    </div>
                    <div class="text-end ">
                        <form action="/basket" method="get">
                            <button type="submit" class="btn btn-outline-success col-sm-8 col-sm offset-1">
                                ...
                                <spring:message code="label.basket"/>
                            </button>
                        </form>
                    </div>
                    <div class="text-end">
                    ...
                    <div class="text-end">
                        <form action="/user/address" method="get">
                            <button type="submit" class="btn btn-outline-success col-sm-8 col-sm offset-1">
                                ...
                                <spring:message code="label.edit.address"/>
                            </button>
                        </form>
                    </div>
                    ...
                    <c:if test="${userPrincipal.role != 'ADMIN'}">
                        <div class="text-end ">
                            <form action="/user/delete" method="post">
                                <button type="submit" class="btn btn-outline-danger col-sm-8 col-sm offset-1"
                                    ...
                                    <spring:message code="label.delete.profile"/>
                                </button>
                            </form>
                        </div>
                    </c:if>
            ...
            <div style="text-align: center">
                <form action="/logout" method="post">
                    ...
                    <button type="submit" style="text-align: center; width: 100%" class="btn btn-outline-danger mb-2">
                        ...
                        <spring:message code="label.sign.out"/>
                    </button>
                </form>
            </div>
        </main>
