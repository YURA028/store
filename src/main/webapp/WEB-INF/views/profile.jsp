        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="card-header bg-white nav">
                ...
                <div class="col p-4 flex-column position-static">
                    ...
                    phone:<b>${userPrincipal.address.phone}</b><br>
                    city: <b>${userPrincipal.address.city}</b><br>
                    street: <b>${userPrincipal.address.street}</b><br>
                    building: <b>${userPrincipal.address.building}</b>
                    <br>
                    <br>
                </div>
                <br><br>
