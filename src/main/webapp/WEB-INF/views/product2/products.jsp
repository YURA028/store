...
<%--                        </form>--%>
<%--                    </c:when>--%>
<%--                    <c:when test="${userPrincipal.email == null}">--%>
<%--                        <a href="${pageContext.request.contextPath}/login">Войти</a></h1>--%>
<%--                    </c:when>--%>
<%--                </c:choose>--%>
<%--            </h3>--%>
<%--            <h4>Товары </h4>--%>
<%--            &lt;%&ndash;            <form action="${pageContext.request.contextPath}/main/product" method="get">&ndash;%&gt;--%>
<%--            &lt;%&ndash;                Поиск по названию объявления: <input type="text" name="name"><br>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                <input type="submit" value="Поиск"/>&ndash;%&gt;--%>

<%--            &lt;%&ndash;            </form>&ndash;%&gt;--%>
<%--            <c:forEach items="${products}" var="product">--%>
<%--                <div>--%>
<%--                    <p><b>${product.name}</b> ${product.price} руб.--%>
<%--                        <a type="submit" href="/product/${product.id}">Подробнее...</a>--%>
<%--                    </p>--%>
<%--                </div>--%>
<%--            </c:forEach>--%>
